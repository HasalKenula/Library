...
public class ReturnServiceImpl implements ReturnService{
    ...
    public String record(ReturnDto returnDto) throws Exception {
        ...
        try {
            ...
            ReturnEntity returnEntity = new ReturnEntity(returnDto.getReturnId(), returnDto.getDate(), returnDto.getMemId(),returnDto.getFine());
            ...
            if(resp.equals("Success")){
                ...
                for (ReturnDetailDto returnDetailDto : returnDto.getReturnDetailDtos()) {
                    ReturnDetailEntity returnDetailEntity = new ReturnDetailEntity(returnDto.getReturnId(),
                            returnDetailDto.getBkCode(), returnDetailDto.getQty());
                ...
                if(isReturnDetailSave){
                    ...
                    for (ReturnDetailDto returnDetailDto : returnDto.getReturnDetailDtos()) {
                        BookEntity bookEntity = bookDao.get(returnDetailDto.getBkCode());
                        bookEntity.setBkQty(bookEntity.getBkQty() + returnDetailDto.getQty());
